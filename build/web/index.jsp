<%-- 
    Document   : index
    Created on : 24/10/2025, 08:43:26 AM
    Author     : diego
--%>

<html>
    <head>
        <title>Pagina  MARTINEZ Aplicacion WEB SOFTWARE JSP - MYSQL </title>
        <meta charset="UTF-8">
...
<!-----------------------------/BOOTSTRAP----------------------------->
    ...
    <body style="background-color: #c9302c">
        <!-- HEADER -------------------------------------------------------------------->
                <header>
                        <!-- MAIN HEADER -->
                        <div id="header">
...
<br>
        <div class="container">
            <center>
                ...
                <h4>LISTA OFICIAL DE USARIOS DE SISTEMA MARTINEZ</h4>
                <br>
            </center>  
                        ...
                        <div class="col-md-3 col-xs-6">
                            <div class="footer">
                                ...
                                <ul class="footer-links">
                                        ...
                                        <li><i class="fa fa-envelope-o"></i>Martinez Zamora Diego Alonso</li>
                                </ul>
                            </div>
